            ...
            if (facebookOAuthResult != null)
            {
                if (facebookOAuthResult.IsSuccess)
                {
                   ...
                   // General.ConnectToSql(sqlcon);
                    ...
                    if (dr.Read() == true)
                    {
                        BranchA_MazalPlus.Forms.UserID.ID = string.Copy(dr[0].ToString());
                        if (dr[6].ToString() == "Admin")
                        {
                            this.Hide();
                            BranchA_MazalPlus.Admin.Menu Connect = new BranchA_MazalPlus.Admin.Menu();
                            Connect.Show();
                        ...
                        {
                            this.Hide();
                            BranchA_MazalPlus.Lecturer.Menu Connect = new BranchA_MazalPlus.Lecturer.Menu();
                            Connect.Show();
                        ...
                        {
                            this.Hide();
                            BranchA_MazalPlus.Teaching_Assistant.Menu Connect = new BranchA_MazalPlus.Teaching_Assistant.Menu();
                            Connect.Show();
